    ...
    data: [
      {
        ...
        tratamiento: 'Señor',
        nombre2: '',
        concepto_busqueda: 'BOLDOS',
        giro: 'AGRICOLA',
        direccion: 'Camino Los Boldos Km 5',
        region: 'X- De los Lagos',
        ciudad: 'Osorno',
        comuna: 'Osorno',
        zona_transporte: 'TIENDA',
        telefono: '642345678',
        celular: '979123456',
        correo_factura: 'facturacion@losboldos.cl',
        razon_social: 'Agricola Los Boldos Ltda.',
        clasificacion_comercial: 'AGRICOLA',
        grupo_control_credito: '1',
      },
      {
        kunnr: '0001000002',
        ...
        sucursal: 'D190',
        tratamiento: 'Señor',
        concepto_busqueda: 'ROBLE',
        giro: 'GANADERIA',
        direccion: 'Ruta 5 Sur Km 932',
        region: 'X- De los Lagos',
        ciudad: 'Osorno',
        comuna: 'San Pablo',
        zona_transporte: 'RURAL',
        celular: '979234567',
        correo_factura: 'admin@fundoelroble.cl',
        razon_social: 'Fundo El Roble SpA',
        clasificacion_comercial: 'GANADERIA',
        grupo_control_credito: '1',
      },
      {
        kunnr: '0001000003',
        ...
        sucursal: 'D190',
        tratamiento: 'Señora',
        concepto_busqueda: 'FCENTRAL',
        giro: 'FERRETERIA',
        direccion: 'Av. Republica 456',
        region: 'X- De los Lagos',
        ciudad: 'Osorno',
        comuna: 'Osorno',
        zona_transporte: 'TIENDA',
        telefono: '642567890',
        celular: '979345678',
        correo_contacto: 'ventas@ferreteriacentral.cl',
        correo_factura: 'facturacion@ferreteriacentral.cl',
        razon_social: 'Ferreteria Central Osorno EIRL',
        clasificacion_comercial: 'FERRETERIA',
        representante_legal: 'Maria Gonzalez Soto',
        grupo_control_credito: '1',
      },
      {
        kunnr: '0001000004',
